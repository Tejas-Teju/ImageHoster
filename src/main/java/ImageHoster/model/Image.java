...
public class Image {
    ...
    //-cascade = CascadeType.REMOVE specifies that if a record in 'images' table is deleted, then all the records in 'comments' table
    // associated to that particular record in 'users' table will be deleted first and then the record in the 'users' table will be deleted
    //FetchType is EAGER
